...
public class ClinicaVeterinaria {
    ...
    private static final String EXEPCIONCLIENTE = "Has causado una excepci�n porque no has entrado un n�mero entero, gracias";
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            String intrEdad = "Introduce la edad";
			switch (numero) {
                case 1:
                    //CLIENTE NUEVO
				altaCliente(teclado, clientes, intrEdad, 2);
                    break;
	...
	private static boolean altaCliente(BufferedReader teclado, ArrayList<Persona> clientes, String intrEdad, int newParam)
			throws IOException {
		System.out.println("INTRODUCIMOS EL CLIENTE");
		System.out.println("Introduce el nombre");
		String nombre = teclado.readLine();
